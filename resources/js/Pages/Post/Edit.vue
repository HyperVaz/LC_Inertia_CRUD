<template>
        ...
        <form @submit.prevent="update">
            ...
            <div class="mb-4">
                <textarea v-model="content" class="w-full rounded-full border-gray-300" type="text"
                          placeholder="content"/>
            </div>
            <div>
                <button class="ml-auto hover:bg-white hover:text-sky-500
                border
                border-sky-500 bg-sky-500 p-2 w-32 rounded-full text-center text-white" type="submit">Update
                </button>
            </div>
        </form>
</template>
